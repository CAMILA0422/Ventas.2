...
public class Eventos {
  ...
  public void textKeyPress(KeyEvent evt) {
    ...
    if ((car >= 'a' && car <= 'z')) {
        // Si la letra es minúscula, la convertimos a mayúscula
        car = Character.toUpperCase(car);
        // Reemplazamos el carácter en el evento
        evt.setKeyChar(car);
    }
    if ((car < 'A' || car > 'Z') && (car != (char) KeyEvent.VK_BACK_SPACE) && (car != (char) KeyEvent.VK_SPACE)) {
        evt.consume();
    }
}
